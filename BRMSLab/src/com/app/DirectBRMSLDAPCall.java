...
public class DirectBRMSLDAPCall {
	  ...
	  //private DirContext ctx = null;
	  //private String[] searchAttrs = { "member" };
	  //public static final String strEnv = System.getProperty("cisco.life");
	  //private static final String principalUser = PropertyLoader.getInstance().getProperty("ldap_principal_user");
	  //private static final String principalPassword = PropertyLoader.getInstance().getProperty("ldap_principal_password");
	  //public static final String ldapUrl;
	  //public static int ldap_count;

		...
		<div id="DisableEnableAlertDiv" style="display: none;">
			...
			<table border="1" cellspacing="2" cellpadding="2" bgcolor="#cee7ff" class="brmsTable" width="100%">
				...
				<% if(sortedMaskEntries.size()>0) { 
					...
					<tr><th>HOST NAME</th><th>PORT</th><th>Mask Individual Nodes : &nbsp;</th><th>Make Nodes Inactive : &nbsp;</th><th>Mask/Inactive Reason</th></tr>
					<%}else{ %>
					<tr><th>HOST NAME:PORT</th><th>Domain</th><th>Mask Individual Nodes : &nbsp;</th><th>Make Nodes Inactive : &nbsp;</th><th>Mask/Inactive Reason</th></tr>
					<%}
					for(Map.Entry<String,Boolean> entry : sortedMaskEntries.entrySet()) {
						...
						<tr>
							...
							<% }%>	
								<th colspan="1" align="left">&nbsp;<select id="selectEnvForED" onchange="resetFormED('<%=strURLPath%>')">
									<option value="DEV">DEV</option>
									<option value="LT">LT</option>
									<option value="STG">STG</option>
									<option value="POC">POC</option>

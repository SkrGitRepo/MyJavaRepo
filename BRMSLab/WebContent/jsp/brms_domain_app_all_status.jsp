		...
		while (lcKeys.hasNext()) {
			...
			if ( lc.get(lifecycle) instanceof JSONObject ) {
				...
				%>
					...
					<th style="border: 1px solid LightGray;">App Status</th>
				...
				%>
						...
						<% } %>
						<td bgcolor="<%=domBgColor%>" style="border: 1px solid LightGray;"><i><a href=<%=domainChildProxyUrl%> target="_blank"><font color="white"><%=domainChildMonStatus%></font></a></i></td></tr>
				<%
					...
					if(domainAllChildJson.has("APPS") && dom_json != null ) {
						...
						%>
							   <tr>
								...
								<%} %>
									<td bgcolor="<%=appBgColor%>" style="border: 1px solid LightGray;"><i><a href=<%=domainAppChildProxyUrl%> target="_blank"><font color="white"><%=domainAppChildMonStatus%></font></a></i></td></tr>
						<% 	} else {
						%>	
								<tr>
								<td style="border: 1px solid LightGray;"><%=domain%>/<%=domainApp%></td>
